...
*/
    ...
    $SQL = ' UPDATE `user` SET `id`=:id,`first_name`=:first_name,`middle_name`=:middle_name,`last_name`=:last_name,`contact_number`=:contact_number,`phone_number`=:phone_number,`address`=:address,`email`=:email,`document_id`=:document_id,`profile_picture_id`=:profile_picture_id WHERE `id`=:id'; 
    $PUSH_DATA = [
