...
function getAuthority($data=null){
    ...
    if($data){
        ...
        switch($_SESSION['MY_AUTHORITY']){
            ...
            case 'CLIENT':
                $AUTHORITY = ['ADMIN','COORDINATOR','FINANCIAL_DEPART','RECEPTIONIST','SUPERVISIOR','TEACHER','OTHERS'];
            break;

            case 'ADMIN':
                $AUTHORITY = ['COORDINATOR','FINANCIAL_DEPART','RECEPTIONIST','SUPERVISIOR','TEACHER','OTHERS'];
            break;
