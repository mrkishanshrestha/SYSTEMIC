    ...
    $('#SEARCH_BOX').on('keyup focusin change', function(event) {
        ...
        jackxData.done(function(data){
            ...
            getFaculty.done(function(data2){
                ...
                juju.makeKaliTable({HEAD:['FACULTY','AMOUNT','ADMISSION FEE'],ID:'FACULTY_TABLE',APPEND:'searchtable'}).then((data)=>{
                    ...
                    jsonData.forEach(element => {
                        ...
                        juju.addTableContent({
                            ...
                            CONTENT_ID:['FACULTY','AMOUNT','ADMISSION_FEE'],
                            CONTENT:[
                                element.short_name,element.amount,element.admission_fee
                            ],
                            EXTRA:{FACULTY:['SELECT_OPTION',['BCA','BBS']]},
                            COUNTER:SNcounter
                        });
                        SNcounter++;
                    });
