...
<section class="main-board" id="main-board">
    ...
    <div class="iconic-card-conatiner">
            ...
            <div class="iconic-card" onclick="juju.changeDash('https://www.systemic.com/ROOT/APPS/CLIENT/CREATE/');">
            ...
            <div class="iconic-card">
                <div><i class="fa-solid fa-magnifying-glass iconic-card-icon" onclick="juju.changeDash('https://www.systemic.com/ROOT/APPS/CLIENT/SEARCH/');"></i></div>
