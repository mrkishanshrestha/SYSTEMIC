<?php include_once '../../../../SYSTEM/IMPORT/BACKEND/kali.php';
$GLOBALS['kali'] = &$kali;
$dataX=[
...
?>
    <?php
        ...
        $kali->link('ROOT/CORE/NAVBAR/SIDENAV/script.js','JS');
        $kali->link('ROOT/CORE/NAVBAR/SIDENAV/design.css','CSS');
    ?>
            ...
            <header>
                <div class='image-text'>
                    ...
                    <div class='text logo-text'>
                        ...
                        <span class='profession'>Heaven</span>
                    </div>
                </div>
