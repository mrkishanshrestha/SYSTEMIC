...
<section class="main-board" id="main-board">
    ...
    <div class="iconic-card-conatiner">
            ...
            <div class="iconic-card" onclick="juju.changeDash('http://client.systemic.com/APPS/FACULTY/CREATE/');">
            ...
            <div class="iconic-card">
                <div><i class="fa-solid fa-magnifying-glass iconic-card-icon" onclick="juju.changeDash('http://client.systemic.com/APPS/FACULTY/SEARCH/');"></i></div>
