...
<h1>Application : Client College</h1>

<section class="main-board" id="main-board">

    <div class="iconic-card-conatiner">
    
            <div class="iconic-card" onclick="juju.changeDash('http://client.systemic.com/APPS/COLLEGE/CREATE/');">
            ...
            <div class="iconic-card">
                <div><i class="fa-solid fa-magnifying-glass iconic-card-icon" onclick="juju.changeDash('http://client.systemic.com/APPS/COLLEGE/SEARCH/');"></i></div>
